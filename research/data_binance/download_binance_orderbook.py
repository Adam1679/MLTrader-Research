...
api_key = "7PnITRp4uAUZuqLXIIaGViZrBmW7TWip5MoO2tJVPOPW0c8b5rYVZYMUvVC6vEh4"
secret_key = "ANubvGyls1py8xiOdtbLqG0yzpIMWStnADzEHGaJmyvv5lzwG7l6dLOP8fUOV1Qz"

# Specify the four input parameters below:
symbol = "ETHUSDT"  # specify the symbol name
startTime = 1692573496000  # specify the starttime
endTime   = 1692659896000  # specify the endtime
