...
product_info["BTCUSDT"] = OrderedDict(
    [
        ("spread", 0.1),
        ("tranct", 4 * 1e-4),
        ("tranct.ratio", True),
...
product_info["ETHUSDT"] = OrderedDict(
    [
        ("spread", 0.01),
        ("tranct", 4 * 1e-4),
        ("tranct.ratio", True),
...
product_info["OPUSDT"] = OrderedDict(
    [
        ("spread", 1e-4),
        ("tranct", 4 * 1e-4),
        ("tranct.ratio", True),
...
product_info["APTUSDT"] = OrderedDict(
    [
        ("spread", 1e-3),
        ("tranct", 4 * 1e-4),
        ("tranct.ratio", True),
...
product_info["1000PEPEUSDT"] = OrderedDict(
    [
        ("spread", 1e-7),
        ("tranct", 4 * 1e-4),
        ("tranct.ratio", True),
